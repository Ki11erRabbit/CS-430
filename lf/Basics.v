...
(*
Fixpoint non_decreasing_add (n : nat) (m : nat) : nat :=
  match n with
  | O => non_decreasing_add m n
  | S n' =>  S (non_decreasing_add n' m)
  end.
*)
(* ################################################################# *)
(** * More Exercises *)
...
Proof.
  ...
  - rewrite -> H. destruct l eqn:El.
    ...
    * simpl. reflexivity.
    * simpl. reflexivity.
    * rewrite <- H. rewrite <- lower_grade_F_Minus. reflexivity.
Qed.
