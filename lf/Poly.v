...
Definition partition {X : Type}
                     ...
                     (l : list X)
                   : list X * list X :=
  (filter test l, filter (fun y => negb (test y)) l).
...
Lemma map_app : forall (X Y : Type) (f : X -> Y) (l : list X) (x : X),
...
Lemma f_distributes_fold_map : forall (X Y : Type) (f : X -> Y) (l : list X) (x : X),
